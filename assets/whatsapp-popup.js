(function () {
  ...
  if (!root) {
    ...
    host.innerHTML = [
      ...
      '<div><h2 class="hz-whatsapp__title" id="hz-whatsapp-title">Request your free briefing</h2><p class="hz-whatsapp__intro">Name, email, and WhatsApp - that is all we need to deliver the briefing.</p></div></header>',
      '<div class="hz-whatsapp__form"><div data-cddform="meigu-dong-us20" data-origin="www.premarketguide.com"></div></div>',
      '<p class="hz-whatsapp__note">Free educational content. Unsubscribe anytime. We don\'t sell your data.</p>',
      '</section></div></div>'
    ].join("");
